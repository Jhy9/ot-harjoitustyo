...
class SaveManager:
    ...
    def load_game(self, file_name):
        """Lataa peliruudukon datan parametrin tekstitiedostosta, luo uuden ruudukon datan perusteella ja palauttaa sen"""
        file = file_name
    ...
    def new_game(self):
        """Arpoo satunnaisen peliruudukon games.txt tiedostosta ja palauttaa sen. Käytetään, kun pelaaja aloittaa uuden pelin"""
    ...
    def add_new(self, board):
        """Lisää uuden pelin games.txt tiedostoon. Peliruudukon voi saada pelattavaksi satunnaisesti, kun käyttäjä aloittaa uuden pelin."""
